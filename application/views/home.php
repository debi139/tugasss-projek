...
<html lang="en">
  <head>
    ...
    <!-- Author Meta -->
    <meta name="author" content="Debi Tri KD">
    <!-- Meta Description -->
    <meta name="description" content="Curriculum Vitae Debi Tri KD">
    <!-- Meta Keyword -->
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
              <div class="contents">
                ...
                <?php
                $str = "https://wa.me/6281215464529?text=Hallo *Debi*, Saya tertarik dengan CV kamu.";
